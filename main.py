...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "download" in active_steps:
            ...
            _ = mlflow.run(
                f"{config['main']['components_repository']}/get_data", # Download the component from GitHub (not local)
                "main",
                version='main', # 'main' refers to the main branch of the GitHub repository.
                env_manager="conda",
                parameters={
        ...
        if "test_regression_model" in active_steps:
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    # use f-strings to construct a string
